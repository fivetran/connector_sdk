...
- [cority](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/cority) - This example shows how to sync four EHS user reports (absences, ohcases, incidents, safetyfindings) from a Cority tenant via the MRWPService SOAP API by using Connector SDK. The connector pages reports larger than the 100,000-row system cap with `GetUserReportResultsNonPreview`. You need to provide your Cority tenant WSDL URL and an integration username and password.
