...
- [coursemill](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/coursemill) - This example shows how to sync learning management data from the CourseMill LMS v7.5 REST API using Connector SDK. It fetches organizations, users, courses, curricula, sessions, enrollments, transcripts, and certificates. You need to provide your CourseMill instance URL and admin credentials for this example to work.
...
- [dtn_weather](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/dtn_weather) - This example shows how to sync weather data from DTN's Observations, Conditions, and Lightning APIs using Connector SDK. It fetches station metadata, daily and hourly forecasts and observations, gridded weather conditions, and lightning strike data. You need to provide your DTN API credentials for this example to work.
...
- [scroll_token](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/common_patterns_for_connectors/pagination/scroll_token) - This is a simple example of how to work with scroll token pagination for a REST API.
- [database_keyset](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/common_patterns_for_connectors/pagination/database_keyset) - This is a simple example of how to work with keyset pagination for a database source.
